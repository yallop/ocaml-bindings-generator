...
(* OASIS_START *)
(* DO NOT EDIT (digest: b3e6100405b4e42b37c1f3ed0702cefa) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A C bindings generator for OCaml";
          description = None;
          categories = [];
          ...
          sections =
            [
               Executable
                 ({
                     cs_name = "ocaml-bindings-generator";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "ocaml_bindings_generator.ml"
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\148$\140\174\141G9\147J\003\031[\bo\142Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
